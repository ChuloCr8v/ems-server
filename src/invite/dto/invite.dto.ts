...
export class CreateProspectDto {
  ...
  @ApiProperty({
    ...
    description: 'Role of the prospect',
  })
  ...
  @IsEnum(JobType, {
    each: true,
    message:
      'Job Type must be one of the following: FULL_TIME, PART_TIME, CONTRACT',
  })
  ...
  @ApiProperty({
    example: '6 months',
    description: 'Duration for contract staff',
  })
...
export class DeclineComment {
  @ApiProperty({
    example: 'Not interested at the moment',
